...
var $author$project$Level1$Level1Init$init = function (a) {
	var newModel = {
		...
		sound: $author$project$Modules$Sound$init(_List_Nil),
				...
				_List_fromArray(
					[
						...
						[
							...
							$author$project$GlobalFunction$GlobalBasics$blockPosFloat(
								_Utils_Tuple2(20, 14)),
							A3($author$project$Modules$Brick$Detailed, 40, 40, '#FFFF00'),
							$author$project$GlobalFunction$GlobalModule$Invisible(
								A2(
			...
			$elm$core$List$concat(
				_List_fromArray(
					[
						...
						A3($author$project$Modules$Brick$initRow, 10, 25, 27),
						function () {
						var base0 = A3(
							$author$project$Modules$Brick$initPosVolumeColor,
							$author$project$GlobalFunction$GlobalBasics$blockPosFloat(
								_Utils_Tuple2(26.1, 9.8)),
							_Utils_Tuple2(32, 8),
							'#700000');
						return _List_fromArray(
							[
						...
						function () {
						var magic2 = $author$project$Modules$Brick$initPos(
							$author$project$GlobalFunction$GlobalBasics$blockPosFloat(
								...
								ship2,
								{
									move: A4(
										...
										A4(
											...
											$author$project$GlobalFunction$GlobalModule$NoNextMove)),
									visibility: $author$project$GlobalFunction$GlobalModule$Invisible(
										A2($author$project$GlobalFunction$GlobalModule$VisibleAfterEvent, 67, $author$project$GlobalFunction$GlobalModule$NoNextVisibility))
								})
							]);
					}()
					]))),
			...
			_List_fromArray(
				[
					...
					return _Utils_update(
						temp,
						{
							duration: $author$project$Modules$Event$quickDuration(9999)
						});
				}(),
					A4(
					$author$project$Modules$Event$hitBlock,
					...
					{id: 67, name: 'ship2'},
					$author$project$Modules$Event$AfterActEvent(62),
					$author$project$Modules$Event$TimeAfterStart(450),
					$author$project$Modules$Event$quickDuration(10)),
					A4(
					$author$project$Modules$Event$init,
					{id: 68, name: 'ship2move'},
					$author$project$Modules$Event$AfterActEvent(67),
					$author$project$Modules$Event$TimeAfterStart(150),
					$author$project$Modules$Event$quickDuration(10))
				])),
		gameControl: A2(
...
var $author$project$MainFunction$MainType$Level7 = {$: 'Level7'};
...
var $author$project$Level7$Level7Init$init = function (a) {
	var newModel = {
		actEvent: $elm$core$Array$fromList(_List_Nil),
		boundary: $author$project$Modules$Boundary$normalInit,
		bricks: $elm$core$Array$fromList(
				...
				_List_fromArray(
					[
						...
						[
							...
							$author$project$GlobalFunction$GlobalBasics$blockPos(
								_Utils_Tuple2(18, 14)),
							$author$project$Modules$Brick$NormalAppearance,
							$author$project$GlobalFunction$GlobalModule$Visible(
								A2($author$project$GlobalFunction$GlobalModule$InvisibleAfterEvent, 3, $author$project$GlobalFunction$GlobalModule$NoNextVisibility)),
							$author$project$GlobalFunction$GlobalModule$NoCollide($author$project$GlobalFunction$GlobalModule$NoNextCollision),
							$author$project$GlobalFunction$GlobalModule$NoNextMove)
						]),
						_List_fromArray(
						...
						[
							...
							$author$project$GlobalFunction$GlobalBasics$blockPos(
								_Utils_Tuple2(22, 8)),
							A3($author$project$Modules$Brick$Detailed, 100, 100, '#000000'),
							$author$project$GlobalFunction$GlobalModule$Visible($author$project$GlobalFunction$GlobalModule$NoNextVisibility),
							$author$project$GlobalFunction$GlobalModule$Collide($author$project$GlobalFunction$GlobalModule$NoNextCollision),
							$author$project$GlobalFunction$GlobalModule$NoNextMove)
						])
							...
							$elm$core$Array$fromList(
								_List_fromArray(
									[
										...
										_Utils_Tuple2(240.0, 440.0)),
										_Utils_Tuple2(
										_Utils_Tuple2(240, 440),
										_Utils_Tuple2(240.0, 480.0)),
										_Utils_Tuple2(
										_Utils_Tuple2(240, 480),
										_Utils_Tuple2(200.0, 480.0)),
										_Utils_Tuple2(
										_Utils_Tuple2(200, 480),
										_Utils_Tuple2(200.0, 440.0))
									])))),
					$author$project$Modules$Event$quickDuration(10)),
					A4(
					$author$project$Modules$Event$init,
						...
						$author$project$GlobalFunction$GlobalBasics$Polygon(
							$elm$core$Array$fromList(
								_List_fromArray(
									[
										_Utils_Tuple2(
										_Utils_Tuple2(660, 500),
										_Utils_Tuple2(660, 540)),
										_Utils_Tuple2(
										_Utils_Tuple2(660, 540),
										_Utils_Tuple2(700, 540)),
										_Utils_Tuple2(
										_Utils_Tuple2(700, 540),
										_Utils_Tuple2(700, 520)),
										_Utils_Tuple2(
										_Utils_Tuple2(700, 520),
										_Utils_Tuple2(660, 500))
									])))),
		...
		keyPressed: _List_Nil,
		levelBoundary: _Utils_Tuple2(2000.0, 680.0),
		mainScene: $author$project$MainFunction$MainType$Level7,
		needles: $elm$core$Array$fromList(
			_List_fromArray(
				[
					A2(
						...
						A3(
							...
							A3(
								...
								A3(
									...
									1,
									'Wow, a moving brick!',
									A3($author$project$Modules$NoticeBoard$VisibleAfterEvent, 3, 'Wow, a fake brick!', $author$project$Modules$NoticeBoard$NoNextNoticeBoardVisibility))))),
					A4(
						$author$project$GlobalFunction$GlobalModule$Move,
						$elm$core$Array$fromList(
							_List_fromArray(
								[
									_Utils_Tuple2(400.0, 400.0)
								])),
						10.0,
						2,
						A4(
		...
		sound: $author$project$Modules$Sound$init(
			_List_fromArray(
				[
					A2($author$project$Modules$Sound$Event, 4, $author$project$Modules$Sound$Sword)
				])),
		windowBoundary: _Utils_Tuple2(1000.0, 800.0)
	};
	return _Utils_Tuple2(
...
var $author$project$Menu$MenuInit$init = function (a) {
	return _Utils_Tuple2(
		{
			buttonState: $elm$core$Array$fromList(
				A2(
...
var $author$project$MainFunction$MainInit$init = function (a) {
	var mainModel = {
		...
		level7Model: $author$project$Level7$Level7Init$init(_Utils_Tuple0).a,
...
var $author$project$MainFunction$MainSubscriptions$subscriptions = function (model) {
...
var $author$project$GlobalFunction$GlobalBasics$ifCollideLSLS = F2(
	function (ls1, ls2) {
		...
		if (A2($author$project$GlobalFunction$GlobalBasics$ifPosOnLs, ls1P1, ls2) || (A2($author$project$GlobalFunction$GlobalBasics$ifPosOnLs, ls1P2, ls2) || (A2($author$project$GlobalFunction$GlobalBasics$ifPosOnLs, ls2P1, ls1) || A2($author$project$GlobalFunction$GlobalBasics$ifPosOnLs, ls2P2, ls1)))) {
			...
			var v1P2_2P2 = A2($author$project$GlobalFunction$GlobalBasics$minusPosPos, ls1P2, ls2P2);
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Tick':
				...
				var _v1 = (!_Utils_eq(model.player.liveState, $author$project$Modules$Player$Dead)) ? $author$project$Modules$Player$updateJustPlayerPos(
...
var $author$project$Level4$Level4Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Tick':
				var timePassed = msg.a;
				var _v1 = (!_Utils_eq(model.player.liveState, $author$project$Modules$Player$Dead)) ? $author$project$Level4$Level4Update$checkWin(
...
var $author$project$Level5$Level5Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Tick':
				var timePassed = msg.a;
				var _v1 = (!_Utils_eq(model.player.liveState, $author$project$Modules$Player$Dead)) ? $author$project$Level5$Level5Update$checkBlueAndRed(
...
var $author$project$Level7$Level7Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Resize':
				var width = msg.a;
			...
			case 'Tick':
				...
				return A2($elm$core$List$member, 82, newModel.keyPressed) ? A2(
					$author$project$Modules$SavePoint$updateReset,
					$author$project$Level7$Level7Init$init,
					_Utils_Tuple2(model, $elm$core$Platform$Cmd$none)) : _Utils_Tuple2(newModel, cmd);
			default:
				var buttonMsg = msg;
				return A2(
					...
					switch (num) {
						case 7:
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{mainStatus: $author$project$MainFunction$MainType$Level7}),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[cmd])));
						case 1:
		...
		switch (_v0.$) {
			case 'Menu':
				...
				return (!_Utils_eq(newMenuModel.mainStatus, $author$project$MainFunction$MainType$Menu)) ? A2(
					...
					cmd);
			case 'Level7':
				var _v2 = A2($author$project$Level7$Level7Update$update, msg, model.level7Model);
				var newLevel7Model = _v2.a;
				var cmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{level7Model: newLevel7Model, mainScene: newLevel7Model.mainScene}),
					cmd);
			case 'Level1':
				var _v3 = A2($author$project$Level1$Level1Update$update, msg, model.level1Model);
				var newLevel1Model = _v3.a;
				var cmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					cmd);
			case 'Level2':
				var _v4 = A2($author$project$Level2$Level2Update$update, msg, model.level2Model);
				var newLevel2Model = _v4.a;
				var cmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					cmd);
			case 'Level3':
				var _v5 = A2($author$project$Level3$Level3Update$update, msg, model.level3Model);
				var newLevel3Model = _v5.a;
				var cmd = _v5.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					cmd);
			case 'Level4':
				var _v6 = A2($author$project$Level4$Level4Update$update, msg, model.level4Model);
				var newLevel4Model = _v6.a;
				var cmd = _v6.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					cmd);
			case 'Level6':
				var _v7 = A2($author$project$Level6$Level6Update$update, msg, model.level6Model);
				var newLevel6Model = _v7.a;
				var cmd = _v7.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					cmd);
			default:
				var _v8 = A2($author$project$Level5$Level5Update$update, msg, model.level5Model);
				var newLevel5Model = _v8.a;
				var cmd = _v8.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			[
				...
				if (_Utils_eq(model.player.liveState, $author$project$Modules$Player$Win)) {
					return A5(
						$author$project$Modules$GameControl$viewOneButton,
						model,
						_Utils_Tuple2(windowBoundaryX / 2.0, windowBoundaryY / 2.0),
	...
	[
		...
		_List_fromArray(
			[
				...
				$elm$svg$Svg$Attributes$xlinkHref('assets/goldenDog.svg')
			]),
		_List_Nil)
	]);
	...
	return $elm$core$List$concat(
		_List_fromArray(
			[
				...
				var windowBoundaryX = _v0.a;
				var windowBoundaryY = _v0.b;
				var _v1 = model.player.deadTimes;
				var deadTimes = _v1.a;
				var deadType = _v1.b;
				if (deadTimes === 1) {
					return _List_Nil;
		...
		[
			...
			_List_fromArray(
				[
					...
					$elm$core$String$fromFloat((windowBoundaryX / 2.0) - 300)),
					$elm$svg$Svg$Attributes$y(
					$elm$core$String$fromFloat((windowBoundaryY / 2.0) - 120)),
					$elm$svg$Svg$Attributes$width(
					$elm$core$String$fromFloat(600)),
					$elm$svg$Svg$Attributes$height(
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$x(
					$elm$core$String$fromFloat(windowBoundaryX / 2)),
					$elm$svg$Svg$Attributes$y(
					$elm$core$String$fromFloat(windowBoundaryY / 2)),
						...
						function () {
							switch (soundEffect.$) {
								case 'BackGround':
									return _List_fromArray(
										[
											$elm$html$Html$Attributes$src('assets/backgroundMusic.ogg'),
											$elm$html$Html$Attributes$id('BackGround')
										]);
								case 'Jump':
									return _List_fromArray(
										[
											$elm$html$Html$Attributes$src('assets/jumpMusic.ogg'),
											$elm$html$Html$Attributes$id('Jump')
										]);
								case 'RandomBox':
									return _List_fromArray(
										[
											$elm$html$Html$Attributes$src('assets/randomBoxMusic.ogg'),
											$elm$html$Html$Attributes$id('RandomBox')
										]);
								case 'Needle':
									return _List_fromArray(
										[
											$elm$html$Html$Attributes$src('assets/needleMusic.ogg'),
											$elm$html$Html$Attributes$id('Needle')
										]);
								case 'Sword':
									return _List_fromArray(
										[
											$elm$html$Html$Attributes$src('assets/swordMusic.ogg'),
											$elm$html$Html$Attributes$id('Sword')
										]);
								default:
									return _List_fromArray(
										[
											$elm$html$Html$Attributes$src('assets/deadMusic.ogg'),
			...
			[
				...
				_List_fromArray(
					[
						...
						(A2($elm$core$List$member, 37, model.keyPressed) || (A2($elm$core$List$member, 39, model.keyPressed) || (A2($elm$core$List$member, 65, model.keyPressed) || A2($elm$core$List$member, 68, model.keyPressed)))) ? $elm$html$Html$Attributes$src('assets/lah.ogg') : ((A2($elm$core$List$member, 38, model.keyPressed) || A2($elm$core$List$member, 87, model.keyPressed)) ? $elm$html$Html$Attributes$src('assets/tech.ogg') : $elm$html$Html$Attributes$src('assets/latex.ogg')),
						$elm$html$Html$Attributes$autoplay(true),
						$elm$html$Html$Attributes$loop(true)
					]),
				_List_Nil)
...
var $author$project$Level7$Level7View$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$core$String$fromFloat(0.0)),
									$elm$svg$Svg$Attributes$width(
									$elm$core$String$fromFloat(model.levelBoundary.a)),
									$elm$svg$Svg$Attributes$height(
									$elm$core$String$fromFloat(model.levelBoundary.b)),
									$elm$svg$Svg$Attributes$transform(''),
									$elm$svg$Svg$Attributes$xlinkHref('assets/background.svg')
								]),
							_List_Nil)
						]),
					_Utils_ap(
...
var $author$project$Menu$MenuView$drawBackground = function (model) {
	var _v0 = model.windowBoundary;
	var windowBoundaryX = _v0.a;
	var windowBoundaryY = _v0.b;
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$x(
					$elm$core$String$fromFloat((windowBoundaryX / 2) - 200.0)),
					$elm$svg$Svg$Attributes$y('100'),
					$elm$svg$Svg$Attributes$fontSize('60'),
					$elm$svg$Svg$Attributes$textAnchor('left'),
					$elm$svg$Svg$Attributes$fill('#A0E6E8')
				]),
			_List_fromArray(
				[
					$elm$svg$Svg$text('Easy Challenges')
				]))
		]);
};
...
var $author$project$MainFunction$MainConstant$menuButtonLevel7 = 7;
	...
	return $elm$core$List$concat(
		_List_fromArray(
			[
				...
				model,
				$author$project$MainFunction$MainConstant$menuButtonLevel7,
				_Utils_Tuple2((windowBoundaryX / 2) - 100.0, 800.0)),
				A3(
				$author$project$Menu$MenuView$drawLevelButton,
				model,
				$author$project$MainFunction$MainConstant$menuButtonLevel1,
				_Utils_Tuple2((windowBoundaryX / 2) - 100.0, 200.0)),
				A3(
				$author$project$Menu$MenuView$drawLevelButton,
				model,
				$author$project$MainFunction$MainConstant$menuButtonLevel2,
				_Utils_Tuple2((windowBoundaryX / 2) - 100.0, 300.0)),
				A3(
				$author$project$Menu$MenuView$drawLevelButton,
				model,
				$author$project$MainFunction$MainConstant$menuButtonLevel3,
				_Utils_Tuple2((windowBoundaryX / 2) - 100.0, 400.0)),
				A3(
				$author$project$Menu$MenuView$drawLevelButton,
				model,
				$author$project$MainFunction$MainConstant$menuButtonLevel4,
				_Utils_Tuple2((windowBoundaryX / 2) - 100.0, 500.0)),
				A3(
				$author$project$Menu$MenuView$drawLevelButton,
				model,
				$author$project$MainFunction$MainConstant$menuButtonLevel5,
				_Utils_Tuple2((windowBoundaryX / 2) - 100.0, 600.0)),
				A3(
				$author$project$Menu$MenuView$drawLevelButton,
				model,
				$author$project$MainFunction$MainConstant$menuButtonLevel6,
				_Utils_Tuple2((windowBoundaryX / 2) - 100.0, 700.0))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$src('assets/rimworldMove.mp3'),
				...
				_Utils_ap(
					$author$project$Menu$MenuView$drawBackground(model),
...
var $author$project$MainFunction$MainView$view = function (model) {
	...
	switch (_v0.$) {
		...
		case 'Level7':
			return $author$project$Level7$Level7View$view(model.level7Model);
		case 'Level1':
