    ...
    let
        newModel =
                ...
                Array.fromList
                    (List.concat
                        ...
                        , [Brick.init
                                ...
                                Brick.NoNextBrickMove]
                        , let
                            tempBoard1 = NoticeBoard.boundaryCollide (7,5) (8,3)
                          in
                          [{tempBoard1 | brickMove = Brick.Move 
                                                        (Array.fromList [])
                                                        0.0
                                                        1
                                                        (Brick.Move 
                        ...
                        , let
                            tempBoard2 = NoticeBoard.boundaryCollide (42,9) (4,1.5)
                          in
                          [{tempBoard2 | brickMove = Brick.Move 
                                                        (Array.fromList [])
                                                        0.0
                                                        6
                                                        (Brick.Move 
            ...
            , noticeBoards =
                Array.fromList
                    [   let
                            tempBoard1 = NoticeBoard.quickInit (GlobalBasics.blockPosFloat ( 10.8,6.8 )) "It's a trap!" 60
                        in
                        {tempBoard1 | noticeBoardMove = NoticeBoard.Move 
                                                                (Array.fromList []) 0.0 1 
                                                                (NoticeBoard.Move (Array.fromList[GlobalBasics.blockPosFloat (10.8,13.8)]) 5.0 -1 NoticeBoard.NoNextNoticeBoardMove)}
                    ,   let
                            tempBoard2 = NoticeBoard.quickInit (GlobalBasics.blockPosFloat ( 44,10 )) "Let's go!" 40
                        in
                        {tempBoard2 | noticeBoardMove = NoticeBoard.Move 
