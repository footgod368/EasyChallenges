            ...
            , bricks =
                Array.fromList
                    (List.concat
                        ...
                        , let
                            tempBrick1 =
                                Brick.initFallingBrick (GlobalBasics.blockPosFloat ( 5.5, 12 )) 1
                          in
                          [ { tempBrick1
                                | appearance = Brick.Detailed 80 80 "#3834ED"
                        ...
                        , let
                            ship =
                                Brick.initPosVolumeColor (GlobalBasics.blockPosFloat ( 21, 10 )) ( 120, 80 ) "#EE82EE"
                          in
                          [ { ship
                                | move =
                                    GlobalModule.Move (Array.fromList [])
                                        0
                                        5
                                        (GlobalModule.Move (Array.fromList [ GlobalBasics.blockPosFloat ( 21, 12 ) ])
                                            3
                                            6
                        ...
                        , let
                            base2 =
                                Brick.initPosVolumeColor (GlobalBasics.blockPosFloat ( 40.1, 9.8 )) ( 32, 8 ) "#700000"
                          in
                          [ { base2
                                | visibility = GlobalModule.Invisible (GlobalModule.VisibleAfterEvent 9 (GlobalModule.InvisibleAfterEvent 30 GlobalModule.NoNextVisibility))
                                , collision = GlobalModule.NoCollide GlobalModule.NoNextCollision
                            }
                          ]
                        , let
                            base1 =
                                Brick.initPosVolumeColor (GlobalBasics.blockPosFloat ( 39.8, 11.1 )) ( 8, 32 ) "#700000"
                          in
                          [ { base1
                                | visibility = GlobalModule.Invisible (GlobalModule.VisibleAfterEvent 9 (GlobalModule.InvisibleAfterEvent 30 GlobalModule.NoNextVisibility))
                                , collision = GlobalModule.NoCollide GlobalModule.NoNextCollision
                                , move =
                                    GlobalModule.Move (Array.fromList [])
                                        0.0
                                        15
                                        (GlobalModule.Move (Array.fromList [ GlobalBasics.blockPosFloat ( 39.8, 11.1 ), GlobalBasics.blockPosFloat ( 39.8, 10.1 ) ])
                                            1.5
                                            19
                        ...
                        , [ Brick.initPosVolumeColor (GlobalBasics.blockPosFloat ( 50, 10 )) ( 40, 40 ) "#FFFF00" ]
                        , let
                            laser3 =
                        ...
                        , let
                            magic2 =
                                Brick.initPosVolumeColor (GlobalBasics.blockPosFloat ( 63.3, 10 )) ( 40, 40 ) "#FFFF00"
                          in
                          [ { magic2
                                | visibility = GlobalModule.Visible (GlobalModule.InvisibleAfterEvent 57 GlobalModule.NoNextVisibility)
                        ...
                        , let
                            laser1a =
                                Brick.initPosVolumeColor (GlobalBasics.blockPosFloat ( 69.1, 7.8 )) ( 32, 8 ) "#700000"
                          in
                          [ { laser1a
                                | move =
                                    GlobalModule.Move (Array.fromList [])
                        ...
                        , let
                            laser2a =
                                Brick.initPosVolumeColor (GlobalBasics.blockPosFloat ( 69.1, 12.8 )) ( 32, 8 ) "#700000"
                          in
                          [ { laser2a
                                | move =
                                    GlobalModule.Move (Array.fromList [])
                        ...
                        , let
                            ship2 =
                                Brick.initPosVolumeColor (GlobalBasics.blockPosFloat ( 73, 13 )) ( 120, 80 ) "#EE82EE"
                          in
                          [ { ship2
                                | move =
                                    GlobalModule.Move (Array.fromList [])
                ...
                Array.fromList
                    [ NoticeBoard.init (GlobalBasics.blockPosFloat ( 38.8, 11.75 ))
                        (NoticeBoard.Invisible
                            (NoticeBoard.VisibleAfterEvent 22
                                "!"
                    ...
                    , NoticeBoard.init (GlobalBasics.blockPosFloat ( 38.8, 11.25 ))
                        (NoticeBoard.Invisible
                            (NoticeBoard.VisibleAfterEvent 24
                                "!"
                    ...
                    , NoticeBoard.init (GlobalBasics.blockPosFloat ( 38.8, 11.5 ))
                        (NoticeBoard.Invisible
                            (NoticeBoard.VisibleAfterEvent 26
                                "!"
                    ...
                    , NoticeBoard.init (GlobalBasics.blockPosFloat ( 22.5, 11 ))
                        (NoticeBoard.Invisible
                            (NoticeBoard.VisibleAfterEvent 4
                                "Follow me ^_^"
                    ...
                    , NoticeBoard.init (GlobalBasics.blockPosFloat ( 26.5, 13 ))
                        (NoticeBoard.Invisible
                            (NoticeBoard.VisibleAfterEvent 32
                                "Jump"
                ...
                Array.fromList
                    (List.concat
                          ...
                          [ { needle0
                                | move =
                                    GlobalModule.Move (Array.fromList [])
                                        0.0
                                        3
                                        (GlobalModule.Move (Array.fromList [ GlobalBasics.blockPosFloat ( 8.5, 25 ) ]) 1.8 -1 GlobalModule.NoNextMove)
                          ...
                          [ { needle1
                                | move =
                                    GlobalModule.Move (Array.fromList [])
                                        0.0
                                        31
                                        (GlobalModule.Move (Array.fromList [ GlobalBasics.blockPosFloat ( 9.5, 25 ) ]) 1.8 -1 GlobalModule.NoNextMove)
                        ...
                        , [ Needle.init (GlobalBasics.blockPosFloat ( 66.4, 5 ))
                                ...
                                (GlobalModule.NoCollide
                                    (GlobalModule.CollideAfterEvent 55
                        ...
                        , [ Needle.init (GlobalBasics.blockPosFloat ( 66.4, 5 ))
                                ...
                                (GlobalModule.NoCollide
                                    (GlobalModule.CollideAfterEvent 59
                        ...
                        , [ Needle.init (GlobalBasics.blockPosFloat ( 66.4, 5 ))
                                ...
                                (GlobalModule.NoCollide
                                    (GlobalModule.CollideAfterEvent 60
